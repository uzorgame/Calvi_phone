...
class LoginService {
  ...
  /* Вийти з акаунта і забрати з телефона все, що йому належало.
   *
   * Доти щоденник лишався лежати місцево, і це виглядало як помилка: людина
   * вийшла, а застосунок повний її записів. На спільному телефоні наступний
   * бачив чужий день, а на своєму щоденник поволі змішувався з новим
   * безіменним акаунтом, бо старі рядки сервер уже прийняв і вдруге вони
   * нікуди не їхали.
   *
   * Тепер вихід стирає місцеву копію цілком. Це не втрата: записи лишаються на
   * сервері під тим акаунтом, і вхід ним же привозить їх назад. Умова одна, і
   * її виконує той, хто кличе цей метод: **спершу дотиснути незіслане нагору**,
   * інакше рядок, який жив тільки на телефоні, зникне назавжди.
   *
   * Google і Apple теж забувають вибір, інакше наступний вхід мовчки зайшов би
  ...
  Future<void> signOut() async {
    ...
    /* Щоденник, профіль, розмова, знімки і курсор черги. Курсор саме тут і
