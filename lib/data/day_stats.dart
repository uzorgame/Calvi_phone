...
class DayStats {
  ...
  ///
  /// Глибина обмежена тим, що привезла база: `watchStats` бере сто двадцять
  /// днів, і довша серія просто впреться в цю межу. Показати менше, ніж було,
  /// чесніше, ніж домалювати дні, про які ми нічого не знаємо.
