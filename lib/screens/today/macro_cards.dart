          ...
          return Row(
            children: [
              _Card(
                ...
                of: L.of(context).macroOfGrams('${goal.protein}${L.of(context).unitG}'),
              ...
              _Card(
                ...
                icon: 'fat',
                value: '${totals.fat}',
                of: L.of(context).macroOfGrams('${goal.fat}${L.of(context).unitG}'),
              ...
              _Card(
                ...
                icon: 'carbs',
                value: '${totals.carbs}',
                of: L.of(context).macroOfGrams('${goal.carbs}${L.of(context).unitG}'),
