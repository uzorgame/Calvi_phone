...
class Dictation implements LevelSource {
  ...
  Future<bool> _start({
    ...
    try {
      ...
      /* Звук тільки коли мікрофон справді відкрився. Програти його наперед було
         б обіцянкою: людина чує «пишу» і говорить у двигун, який не піднявся.
