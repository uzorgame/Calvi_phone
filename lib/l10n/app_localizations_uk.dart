...
class LUk extends L {
  ...
  String get accountSignOutBack =>
      'Увійди тим самим акаунтом, і все повернеться на місце. Те, що записано без інтернету і ще не доїхало на сервер, повернути не вийде.';

  @override
  String get accountSignOutNote =>
      'Цей телефон стане чистим: щоденник, профіль, препарати і розмова з Норою зникнуть із нього. Записи лишаються на сервері, під твоїм акаунтом.';
  ...
  String get deleteAskBody2 =>
      'На сервері акаунт стане в чергу на остаточне видалення: воно займає до 30 робочих днів. Доки ми його не підтвердимо, вхід тим самим акаунтом поверне все назад і скасує запит.';
  ...
  @override
  String get deleteProManage => 'Керувати підпискою';

  @override
  String deleteProNote(String store) {
    return 'Видалення акаунта не скасовує Calvi Pro. $store списуватиме гроші й далі, доки саму підписку не скасовано, тому скасувати її треба до видалення акаунта.';
  }
