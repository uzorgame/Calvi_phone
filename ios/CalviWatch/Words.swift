...
struct Words {
  ...
  private static let all: [String: Words] = [
    "uk": Words(
      ...
      dryBody: "Я поки мовчу. Запис рукою в телефоні працює й далі.",
      queuedHead: "У черзі",
    ...
    "en": Words(
      ...
      dryBody: "I am quiet for now. Logging by hand on the phone still works.",
      queuedHead: "Queued",
    ...
    "es": Words(
      ...
      dryHead: "Sin tokens",
      dryBody: "Por ahora callo. Anotar a mano en el teléfono sigue funcionando.",
      queuedHead: "En cola",
    ...
    "it": Words(
      ...
      dryBody: "Per ora taccio. Registrare a mano sul telefono funziona ancora.",
      queuedHead: "In coda",
    ...
    "de": Words(
      ...
      dryBody: "Ich bin vorerst still. Von Hand eintragen am iPhone geht weiter.",
    ...
    "fr": Words(
      ...
      dryBody: "Je me tais pour l’instant. Noter à la main sur le téléphone marche toujours.",
    ...
    "pt": Words(
      ...
      dryHead: "Sem tokens",
      dryBody: "Fico em silêncio por ora. Registrar à mão no telefone continua funcionando.",
      queuedHead: "Na fila",
    ...
    "pl": Words(
      ...
      dryBody: "Na razie milczę. Ręczny zapis w telefonie nadal działa.",
