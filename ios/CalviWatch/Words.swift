...
struct Words {
  ...
  private static let all: [String: Words] = [
    ...
    "cs": Words(
      say: "Řekni",
      openPhone: "Otevři Calvi v telefonu",
      left: "Zbývá %@",
      planDone: "Plán splněn",
      planOver: "Plán překročen",
      listening: "Poslouchám…",
      done: "Hotovo",
      analysing: "Analyzuji",
      logged: "Zapsáno",
      praise: "Jdeš si za cílem!",
      dryHead: "Tokeny došly",
      dryBody: "Teď chvíli mlčím. Ruční zápis v telefonu funguje dál a je zdarma.",
      queuedHead: "Ve frontě",
      queuedBody: "Není síť. Odešlu to sama, jakmile se vrátí.",
      failHead: "Nepovedlo se",
      notHeard: "Neslyšela jsem. Řekni to znovu",
      phoneFar: "Telefon je daleko. Přijď blíž a řekni to znovu",
      phoneSilent: "Telefon neodpověděl",
      phoneOffline: "Telefon je bez sítě",
      serverSilent: "Server neodpověděl",
      micDenied: "Povol mikrofon v Nastavení",
      micFailed: "Mikrofon neodpověděl",
      water: "Voda",
      perDay: "%@ dnes",
      toNorm: "Ještě %@",
      weight: "Váha",
