...
struct Words {
  ...
  private static let all: [String: Words] = [
    ...
    "ru": Words(
      say: "Сказать",
      openPhone: "Открой Calvi на телефоне",
      left: "Осталось %@",
      planDone: "План выполнен",
      planOver: "План перевыполнен",
      listening: "Слушаю…",
      done: "Готово",
      analysing: "Анализирую",
      logged: "Записала",
      praise: "Ты хорошо идёшь к цели!",
      dryHead: "Токены кончились",
      dryBody: "Я пока молчу. Запись рукой в телефоне работает и дальше, она бесплатная.",
      queuedHead: "В очереди",
      queuedBody: "Нет сети. Отправлю сама, как только она появится.",
      failHead: "Не вышло",
      notHeard: "Не услышала. Скажи ещё раз",
      phoneFar: "Телефон далеко. Подойди к нему и скажи ещё раз",
      phoneSilent: "Телефон не ответил",
      phoneOffline: "Телефон без сети",
      serverSilent: "Сервер не ответил",
      micDenied: "Разреши микрофон в настройках",
      micFailed: "Микрофон не ответил",
      water: "Вода",
      perDay: "за день %@",
      toNorm: "Ещё %@ до нормы",
      weight: "Вес",
    ...
    "be": Words(
      say: "Сказаць",
      openPhone: "Адкрый Calvi ў тэлефоне",
      left: "Засталося %@",
      planDone: "План выкананы",
      planOver: "План перавыкананы",
      listening: "Слухаю…",
      done: "Гатова",
      analysing: "Аналізую",
      logged: "Запісала",
      praise: "Ты добра ідзеш да мэты!",
      dryHead: "Токены скончыліся",
      dryBody: "Я пакуль маўчу. Запіс рукой у тэлефоне працуе і далей, ён бясплатны.",
      queuedHead: "У чарзе",
      queuedBody: "Няма сеткі. Дашлю сама, як толькі яна зʼявіцца.",
      failHead: "Не выйшла",
      notHeard: "Не пачула. Скажы яшчэ раз",
      phoneFar: "Тэлефон далёка. Падыдзі да яго і скажы яшчэ раз",
      phoneSilent: "Тэлефон не адказаў",
      phoneOffline: "Тэлефон без сеткі",
      serverSilent: "Сервер не адказаў",
      micDenied: "Дазволь мікрафон у наладах",
      micFailed: "Мікрафон не адказаў",
      water: "Вада",
      perDay: "за дзень %@",
      toNorm: "Яшчэ %@ да нормы",
      weight: "Вага",
      perWeek: "%@ за тыдзень",
      toGoal: "Да мэты %@",
      minutes: "хв",
