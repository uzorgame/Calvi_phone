...
void main() {
   ...
   *
   * Тією ж дорогою ходить зміна мови. Слова в острівець і в сповіщення їдуть
   * готовими з Dart, а числа лишаються ті самі, тому без забування запис
   * говорив би попередньою мовою до першої записаної страви. */
