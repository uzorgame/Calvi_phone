...
void main() {
  ...
  Future<void> open(WidgetTester tester, Widget screen, String lang, Size size) async {
    ...
    /* Дерево зноситься перед кожною мовою, а не перебудовується поверх
     * попередньої.
     *
     * `pumpWidget` з тією самою будовою лишає стан живим, а підказка під полем
     * вводу крутиться по колу за таймером і живе саме там. Через це кожна
     * наступна мова мірялась на іншій підказці, ніж англійська, з якою її
     * порівнюють: англійська стояла на «Nora», а дев'ята мова на «Два яйця і
     * тост». Тест роками проходив випадково, і зламався рівно тоді, коли дві
     * нові мови зсунули лічильник. */
