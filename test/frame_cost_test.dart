...
///
/// Тут вони перелічені поіменно: на дні зараз шістнадцять розмиттів і два шари.
/// Шістнадцяте це смуга нутрієнтів під картками макросів: вона картка, як усі
/// решта, і тінь у неї така сама. Стеля не істина в останній інстанції, а межа,
