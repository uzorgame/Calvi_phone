...
void main() {
  testWidgets('картка стоїть на боці калорій і має висоту', (tester) async {
     ...
     *
     * 624 зʼїдених і 1926 лишку: 2240 норми з налаштувань плюс 310 спалених
     * мінус зʼїдене. Спалене повертається в норму, тому воно доданок. */
    ...
    expect(
      find.textContaining('1 926', findRichText: true),
      findsWidgets,
