...
void main() {
  testWidgets('картка стоїть на боці калорій і має висоту', (tester) async {
     ...
     *
     * 624 зʼїдених і 1966 лишку: 2280 норми з налаштувань плюс 310 спалених
     * мінус зʼїдене. Спалене повертається в норму, тому воно доданок. Норма
     * рахується з ваги на старті цілі (81 кг у демо-людини), а не з живої:
     * зважування її не рухають. */
    expect(find.textContaining('624', findRichText: true), findsWidgets, reason: 'зʼїдене');
    expect(
